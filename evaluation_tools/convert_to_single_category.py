...
def convert_to_single_category(geojson_file, category_num, output_name, output_dir):
    data = gpd.read_file(geojson_file)
    for index, row in data.iterrows():
        data['category_num'][index] = category_num
    write_json(data, output_name, output_dir)


if __name__ == '__main__':
    geojson_file = '/home/huangbo/harvey/evaluation/retinanet-2017-12-21/threshold=0.1/pre/pre_transfer.geojson'
    output_name = 'pre_single'
    output_dir = '/home/huangbo/harvey/evaluation/retinanet-2017-12-21/threshold=0.1/pre'
    category_num = 0
    convert_to_single_category(geojson_file, category_num, output_name, output_dir)